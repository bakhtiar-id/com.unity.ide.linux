# IDE Support Package for Linux

## [2.0.24] - 2025-06-25

Integration:

- **BREAKING**: Renamed from VS Code Insiders specific to generic Linux IDE support
- **BREAKING**: Updated namespace from `Microsoft.Unity.VSCodeInsiders.Editor` to `Microsoft.Unity.IdeLinux.Editor`
- **BREAKING**: Updated assembly name from `Unity.VSCodeInsiders.Editor` to `Unity.IdeLinux.Editor`
- **BREAKING**: Updated package name from `com.unity.ide.vscode-insiders` to `com.unity.ide.linux`
- Focused plugin exclusively on VS Code engine-based editors for Linux
- Removed support for regular VS Code (handled by official Unity plugin)
- Removed Windows and macOS support to avoid conflicts with official plugin
- Updated discovery logic to support VS Code Insiders and future VS Code engine-based editors on Linux
- Prepared infrastructure for supporting additional editors like Cursor, Zed, or other VS Code engine variants

Project generation:

- Maintained all existing project generation capabilities for supported editors
