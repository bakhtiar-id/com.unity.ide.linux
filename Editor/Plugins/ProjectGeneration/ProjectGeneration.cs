...
namespace Microsoft.Unity.IdeLinux.Editor
{
	...
	public class ProjectGeneration : IGenerator
	{
		...
		ILinuxIdeInstallation m_CurrentInstallation;
		...
		private void CreateExtraFiles(ILinuxIdeInstallation installation)
		{
		...
		{
			var editor = CodeEditor.CurrentEditor as LinuxIdeEditor;
			editor?.TryGetLinuxIdeInstallationForPath(CodeEditor.CurrentEditorInstallation, lookupDiscoveredInstallations: true, out m_CurrentInstallation);
		}
		...
		)
		{
			...
			var projectProperties = new ProjectProperties
			{
				...
				FlavoringPackageVersion = LinuxIdeIntegration.PackageVersion(),
			};
